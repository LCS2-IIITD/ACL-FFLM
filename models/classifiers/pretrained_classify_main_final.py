...
if __name__ == '__main__':
    ...
    store_folder = working_folder + '/results/generate-embed/' + folder_name + '/' + pretrained_model_names[0]
    output_folder = working_folder + '/results/classifiers/' + folder_name + '/' + pretrained_model_names[0]

    DR_tech = None
    DUMP_MODE = True
    dimen_size = None
    if DR_tech != None : dimen_size = 32
    ...
    for num_classes in num_classes_arr:
        for i,nftrainsamples_per_class in enumerate(nftrainsamples_per_class_arr):
            ...
            for model_name in pre_model_names:
                ...
                output_folder += '/' + str(min_nf_tokens) + '/' + path_str + '/'
                ...
                grid_search_cv_folder = output_folder  + 'grid_search/'
...
#                     if classifier_name == 'svm' or classifier_name == 'knn':
#                         continue
